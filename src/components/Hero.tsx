    ...
    >
      <div className="space-y-6">
        <h1 className="text-4xl md:text-6xl font-bold animate-fade-in-up">
          I'm <span className="text-brand-primary">Rishabh</span>
        </h1>
        <p
          className="text-2xl md:text-4xl font-light text-brand-text-secondary animate-fade-in-up"
        ...
        <div
          className="flex justify-center space-x-6 pt-4 animate-fade-in-up"
