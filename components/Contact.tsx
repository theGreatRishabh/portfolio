    ...
    <div className="grid md:grid-cols-2 gap-12 bg-brand-surface p-8 rounded-lg mt-12">
      <div className="space-y-6">
        ...
        <p className="text-brand-text-secondary">
          ...
          projects, creative ideas, or opportunities to be part of an amazing
          team. Drop me a line or a query for collaboration and I'll get back to you as soon as I can.
        </p>
