...
const Footer: React.FC = () => {
    return (
        <footer className="bg-brand-surface py-8">
            <div className="container mx-auto px-6 md:px-12 text-center text-brand-text-secondary">
                ...
                <p>&copy; {new Date().getFullYear()} Rishabh Singh. All Rights Reserved.</p>
            </div>
        </footer>
    );
};
